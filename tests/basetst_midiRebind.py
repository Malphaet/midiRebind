...
import midiRebind
# from midiRebind.minitest import minitest
#
#
...
#             self.addSuccess()
#
#         # I'm ignoring the None case on purpose because I can't be bothered with, if it fails, it might as well fail big
...
#                     self.addSuccess()
#                 except:
#                     self.addFailure("Can't access the fire section")
#         except:
