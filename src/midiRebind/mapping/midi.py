...
class MessageParse(BasicMessageParse):
    """Parsing of a midi message this parser is used once and will return a different Action object every time it is
    called """

    def __init__(self):
        # The data is converted from hex to decimal for readability and usability by mido
        self.type = None  # note_off note_on control_change program_change sysex (technically all the others but we
